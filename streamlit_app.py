...
# Example macOS: export DATA_DIR="/Users/you/Library/CloudStorage/OneDrive-OrgName/form-data"
...
if os.path.exists(CSV_PATH):
    try:
        ...
        st.dataframe(rows[-10:], use_container_width=True) if rows else st.info("No submissions yet.")
    except Exception as e:
